...
class Wxpay_client_pub extends Common_util_pub
{
	...
	//二次签名
	function createSignToo($prepayid){
			$this->parameters["appid"] = WxPayConf_pub::APPID;//公众账号ID
			$this->parameters["partnerid"] = WxPayConf_pub::MCHID;//商户号
			$this->parameters["prepayid"] = $prepayid;
			$this->parameters["package"] = 'Sign=WXPay';
			$this->parameters["noncestr"] = $this->createNoncestr();
