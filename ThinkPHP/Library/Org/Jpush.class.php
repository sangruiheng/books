...
namespace Org;
class Jpush{
        private $app_key = '3bef1ce42970a1147f705678';        //待发送的应用程序(appKey)，只能填一个。
        private $master_secret = '08771604c7b9a9d3217656e0';    //主密码
        ...
        */
        ...
        public function push($receiver='all',$title,$content='',$extras){
