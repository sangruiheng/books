...
<nav class="navbar navbar-default" role="navigation">
	<div class="navbar-header">
		<a class="navbar-brand" href="#">讲故事分类管理</a>
	</div>
	<div>
		...
		<button type="button" class="btn btn-info navbar-btn listButton" onclick="editData('addTellingScategory')"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 修改</button>
		<button type="button" class="btn btn-success navbar-btn listButton" onclick="openAddData('addTellingScategory')"><i class="fa fa-plus" aria-hidden="true"></i> 新建</button>
		<form class="navbar-form navbar-right listSearch" role="search" method="get" action="/manage.php/Scategory/tellingScategoryList">
...
<div class="list-box">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<!--<td>-->
					<!--<a class="btn btn-success navbar-btn" href="/manage.php/Salbum/tellingSalbumList?scategory_id=<?php echo ($vo["id"]); ?>&scategory_name=<?php echo ($vo["scategory_name"]); ?>" > 专辑管理</a>-->
				<!--</td>-->
