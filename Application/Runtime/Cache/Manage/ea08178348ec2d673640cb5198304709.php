...
<nav class="navbar navbar-default" role="navigation">
    <div class="navbar-header">
        <a class="navbar-brand" href="#"><i class="fa fa-plus" aria-hidden="true"></i> <span id="changeTitle">添加</span>讲故事分类</a>
    </div>
</nav>

<div class="add-box">
    <form class="addForm ajax-alert" id="form1" name="form1" method="post"
          action="/manage.php/Scategory/addTellingScategoryData/controller/Scategory/backUrl/tellingScategoryList/table/scategory">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td align="center">讲故事分类名称</td>
                <td><input type="text" name="scategory_name" id="scategory_name" class="form-control" placeholder="请输入讲故事分类名称"/>
                </td>
            </tr>
